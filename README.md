...
# My SVN server is [here](https://bit.ly/hdg57server) with username `Public` and password `a`. Ignore phishing warnings. Case sensitive.
...
- 👯 I’m looking to collaborate on [3dos](https://bit.ly/hdg57server)
